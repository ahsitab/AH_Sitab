...
document.querySelectorAll('.section-title, .about-card, .edu-card, .skill-category-box, .project-card, .faq-item, .interest-card, .achievement-category-card').forEach((el, index) => {
    el.style.opacity = '0';
